...
public class Koloda {
    ...
    public Koloda() {
        ...
        cards.add(new Card("Колроль трефа", 10));
        cards.add(new Card("Колроль бубна", 10));
        cards.add(new Card("Колроль пика", 10));
        cards.add(new Card("Колроль черви", 10));
...
//Колода должна вернуть рандомную карту